...
const SOLIS_AGENTS = [
  ...
  { id: 'solis-linkedin', name: 'LinkedIn Agent', status: 'inactive' as const, role: 'linkedin_poster', family: 'marketing', department: 'Marketing', workspaceId: 2, model: 'claude', description: 'Manages LinkedIn presence for Solis Energy - thought leadership, project showcases, and B2B content', tools: [], constraints: {}, systemPrompt: '', createdAt: new Date(), lastRunAt: null, lastRunStatus: null, executionCount: 0, successRate: 0 },
  { id: 'solis-youtube', name: 'YouTube Agent', status: 'inactive' as const, role: 'youtube_manager', family: 'marketing', department: 'Marketing', workspaceId: 2, model: 'claude', description: 'Manages YouTube channel for Solis Energy - install videos, testimonials, and solar education content', tools: [], constraints: {}, systemPrompt: '', createdAt: new Date(), lastRunAt: null, lastRunStatus: null, executionCount: 0, successRate: 0 },
...
const QUOTEPATH_AGENTS = [
  ...
  { id: 'qp-linkedin', name: 'LinkedIn Agent', status: 'inactive' as const, role: 'linkedin_poster', family: 'marketing', department: 'Marketing', workspaceId: 3, model: 'claude', description: 'Manages LinkedIn presence for QuotePath - thought leadership, product updates, and B2B content', tools: [], constraints: {}, systemPrompt: '', createdAt: new Date(), lastRunAt: null, lastRunStatus: null, executionCount: 0, successRate: 0 },
  { id: 'qp-youtube', name: 'YouTube Agent', status: 'inactive' as const, role: 'youtube_manager', family: 'marketing', department: 'Marketing', workspaceId: 3, model: 'claude', description: 'Manages YouTube channel for QuotePath - tutorials, demos, and quoting workflow content', tools: [], constraints: {}, systemPrompt: '', createdAt: new Date(), lastRunAt: null, lastRunStatus: null, executionCount: 0, successRate: 0 },
...
const MONETURA_AGENTS = [
  ...
  { id: 'mon-linkedin', name: 'LinkedIn Agent', status: 'inactive' as const, role: 'linkedin_poster', family: 'marketing', department: 'Marketing', workspaceId: 1, model: 'claude', description: 'Manages LinkedIn presence for Monetura Media - thought leadership, case studies, and B2B content', tools: [], constraints: {}, systemPrompt: '', createdAt: new Date(), lastRunAt: null, lastRunStatus: null, executionCount: 0, successRate: 0 },
  { id: 'mon-youtube', name: 'YouTube Agent', status: 'inactive' as const, role: 'youtube_manager', family: 'marketing', department: 'Marketing', workspaceId: 1, model: 'claude', description: 'Manages YouTube channel for Monetura Media - agency insights, client showcases, and marketing education content', tools: [], constraints: {}, systemPrompt: '', createdAt: new Date(), lastRunAt: null, lastRunStatus: null, executionCount: 0, successRate: 0 },
